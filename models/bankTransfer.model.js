...
const bankTransferSchema = new Schema(
    {
        ...
        reject_reason: { type: String, max: 500, required: false, default: null },
        ...
        reject_by: { type: mongoose.Schema.Types.ObjectId, ref: USER, required: false, default: null },
        deleted_at: { type: Date, required: false, default: null },
        approved_at: { type: Date, required: false, default: null },
        reject_at: { type: Date, required: false, default: null },
